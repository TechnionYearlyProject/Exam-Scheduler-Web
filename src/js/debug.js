...
//
//     for(var i in cs){
//         sendRequest('PUT', '/api/2018-spring/course/'+cs[i].id+'/set_conflicts',cs[i],function(out){
//             console.log(out);
//         });
//         sendRequest('PUT', '/api/2018-winter/course/'+cs[i].id+'/set_conflicts',cs[i],function(out){
//             console.log(out);
//         })
//     }
//
